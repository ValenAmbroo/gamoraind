-- Script para crear la base de datos del inventario de Gamora Indumentaria
-- Este script crea las tablas necesarias para manejar productos con diferentes tipos de talles
...
-- =====================================================
-- Insertar los talles para cada categoría
-- =====================================================
...
CREATE PROCEDURE sp_ObtenerTallesPorCategoria
    @CategoriaId INT
AS
BEGIN
    SELECT 
