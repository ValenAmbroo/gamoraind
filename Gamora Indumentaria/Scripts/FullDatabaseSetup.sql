-- Script completo para crear la base de datos VentasDB del inventario de Gamora Indumentaria
...
PRINT 'Setup completo de la base de datos VentasDB finalizado exitosamente.';
